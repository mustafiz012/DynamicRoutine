...
public class Wednesday extends ActionBarActivity implements View.OnClickListener {
		...
		if (v == createCourses){
			...
			createBuilder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					if (cName.isEmpty()) {
						Toast.makeText(Wednesday.this, "Don't make it blank!!", Toast.LENGTH_SHORT).show();
					} else {
						//counter++;
						Toast.makeText(Wednesday.this, "Courses Added: " + cName, Toast.LENGTH_SHORT).show();
			...
			deleteCourse.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					final String cName = courseName.getText().toString();
					if (cName.isEmpty()) {
						Toast.makeText(Wednesday.this, "Nothing To Delete!", Toast.LENGTH_SHORT).show();
					} else {
	...
	public void courseViewer() {
		...
		for (Map.Entry<String, ?> entry : allName.entrySet()) {
			...
			rowTextView.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
					Toast.makeText(Wednesday.this, "This is "+courseName, Toast.LENGTH_SHORT).show();
				}
			});
