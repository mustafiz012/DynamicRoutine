...
public class Sunday extends ActionBarActivity implements View.OnClickListener {
		...
		if (v == createCourses){
			...
			createBuilder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					if (cName.isEmpty()) {
						Toast.makeText(Sunday.this, "Don't make it blank!!", Toast.LENGTH_SHORT).show();
					} else {
						//counter++;
						Toast.makeText(Sunday.this, "Courses Added: " + cName, Toast.LENGTH_SHORT).show();
			...
			deleteCourse.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					final String cName = courseName.getText().toString();
					if (cName.isEmpty()) {
						Toast.makeText(Sunday.this, "Nothing To Delete!", Toast.LENGTH_SHORT).show();
					} else {
	...
	public void courseViewer() {
		...
		for (Map.Entry<String, ?> entry : allName.entrySet()) {
			...
			rowTextView.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
					Toast.makeText(Sunday.this, "This is "+courseName, Toast.LENGTH_SHORT).show();
				}
			});
