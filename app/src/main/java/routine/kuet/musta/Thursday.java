...
public class Thursday extends ActionBarActivity implements View.OnClickListener {

	Button createCourses, deleteCourses, home;
	LinearLayout showCourse;
	TextView[] tvName;
	int counter =0;
	SharedPreferences spCreateName;
	SharedPreferences.Editor editor, eCreateName;
	@Override
		...
		if (v == createCourses){
			...
			createBuilder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					if (cName.isEmpty()) {
						Toast.makeText(Thursday.this, "Don't make it blank!!", Toast.LENGTH_SHORT).show();
					} else {
						//counter++;
						Toast.makeText(Thursday.this, "Courses Added: " + cName, Toast.LENGTH_SHORT).show();
			...
			deleteCourse.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					final String cName = courseName.getText().toString();
					if (cName.isEmpty()) {
						Toast.makeText(Thursday.this, "Nothing To Delete!", Toast.LENGTH_SHORT).show();
					} else {
	...
	public void courseViewer() {
		...
		for (Map.Entry<String, ?> entry : allName.entrySet()) {
			...
			rowTextView.setBackgroundDrawable(getDrawable(R.drawable.custom_bg_22));
			rowTextView.setId(i);
			...
			rowTextView.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
					Toast.makeText(Thursday.this, "This is "+courseName, Toast.LENGTH_SHORT).show();
				}
			});
